...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/notes',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Notes') : const NotesWidget(),
        ),
        FFRoute(
          name: 'CompleteTasks',
          path: '/completeTasks',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CompleteTasks')
              : const CompleteTasksWidget(),
        ),
        FFRoute(
          name: 'AddNewNote',
          path: '/addNewNote',
          builder: (context, params) => const AddNewNoteWidget(),
        ),
        FFRoute(
          name: 'details',
          path: '/details',
        ...
        FFRoute(
          ...
          builder: (context, params) => NotesEditWidget(
